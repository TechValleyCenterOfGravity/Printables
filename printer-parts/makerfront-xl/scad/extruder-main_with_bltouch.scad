...
difference(){
    bltouch_prusa_mount();
    translate([-(8.9*2+2.5+.1)+2.5,44-22.8-5-3+.05-4,15])
        cube([8.9*2+2.5+.2,10.2+4,15.1]);
}
...
difference(){
    bltouch_prusa_mount();
    translate([-(8.9*2+2.5+.1)+2.5,44-22.8-5-3+.05-4,-.1])
        cube([8.9*2+2.5+.2,10.2+4,15.1]);
}
}
...
module bltouch_prusa_mount(){
    translate([0,-4,0])union(){
        translate([-8.899,-1.5+.15+(44-22.8),15])rotate([90,180,0])         bltouch_bracket();
        translate([0,44-22.8-5-3+.15,0]) difference() {
            rotate([0,0,45])cube([sqrt(50),sqrt(50),15-6.5]);
            translate([0,0,-.1]) cube([5,10,15+.2]);
            translate([-5,5,-.1]) cube([10,5,15+.2]);
        }
        translate([0,44-22.8-5-3+.15+4,0])cube([2,10,8.5]);
        translate([0,44-22.8-5-3+.15,21.5]) difference() {
            rotate([0,0,45])cube([sqrt(50),sqrt(50),15-6.5]);
            translate([0,0,-.1]) cube([5,10,15+.2]);
            translate([-5,5,-.1]) cube([10,5,15+.2]);
        }
        translate([0,44-22.8-5-3+.15+4,21.5])cube([2,10,8.5]);
    }
}
    extruder_body();
